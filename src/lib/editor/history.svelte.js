...
function step(from, to, dir) {
  ...
  try {
    ...
    if (id) {
      if (pageById(entry.pageId)?.boxes.some((b) => b.id === id)) selectBox(id, { activate: false });
