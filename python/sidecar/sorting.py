# Vendored verbatim from MangaTranslator (Apache-2.0), grinnch:
#   https://github.com/meangrinch/MangaTranslator  core/image/sorting.py
# Panel-aware manga reading-order sort. Pure Python, no extra deps.
